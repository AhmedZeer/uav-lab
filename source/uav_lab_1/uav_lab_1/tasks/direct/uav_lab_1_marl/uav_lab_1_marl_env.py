...
from .uav_lab_1_marl_env_cfg import UavLab1MarlEnvCfg


class UavLab1MarlEnv(DirectMARLEnv):
    cfg: UavLab1MarlEnvCfg

    def __init__(self, cfg: UavLab1MarlEnvCfg, render_mode: str | None = None, **kwargs):
